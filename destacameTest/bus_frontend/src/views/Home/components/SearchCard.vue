...
export default {
  ...
  mounted() {
    this.today = this.day.getFullYear() + '-' + ('0' + (this.day.getMonth() + 1)).slice(-2) + '-' + (this.day.getDate()),//Format the date
    this.getCourses() // Retrieve data for the table
  },
    computed: {
  ...
  methods: {
    ...
    getDestination(){
        // Get the destinations related with an specific origin
        axios({
            method: 'get',
    ...
    searchTrips(){
        // Redirect to Service View when form is submitted
